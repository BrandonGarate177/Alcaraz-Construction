  ...
  return (
    ...
    <main>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        {/* Header with Logo */}
        <div className="absolute top-0 left-0 right-0 z-10 py-4 sm:py-6">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <img 
                  src="/logo.jpeg" 
                  alt="Alcaraz Construction Logo" 
                  className="h-10 sm:h-12 lg:h-14 w-auto"
                />
                <div className="ml-3 sm:ml-4">
                  <div className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">
                    Alcaraz Construction
                  </div>
                  <div className="text-xs sm:text-sm text-gray-600 font-medium">
                    Professional Remodeling & Construction - San Diego
                  </div>
                </div>
              </div>
              
              {/* Optional: Contact info in header */}
              <div className="hidden md:flex items-center gap-4">
                <a href="tel:+16193619906" className="flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-primary-600 transition-colors">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.72 19.72 0 0 1-8.59-3.07A19.5 19.5 0 0 1 3.15 9.77 19.72 19.72 0 0 1 .08 1.18 2 2 0 0 1 2.06-.9999999e-7h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L6.16 8.41a16 16 0 0 0 7.43 7.43l1.77-1.15a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92Z" />
                  </svg>
                  (619) 361-9906
                </a>
              </div>
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-32 mt-16 sm:mt-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-8 sm:mb-12">
              <div className="inline-block mb-3 sm:mb-4 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-primary-500/10 to-blue-500/10 rounded-full border border-primary-200/30">
                <span className="text-primary-700 font-semibold text-xs sm:text-sm tracking-wide uppercase">Professional Construction Services</span>
              </div>
            ...
            <div className="mb-12 sm:mb-16">
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed font-light px-2 sm:px-0">
                Transform your San Diego property with our expert construction and remodeling services. 
                <span className="block mt-2 sm:mt-3 font-medium text-gray-800">
                  From concrete work to complete renovations, we build your vision into reality.
                </span>
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-2xl mx-auto text-sm md:text-base text-gray-700 mb-8 sm:mb-12 px-2 sm:px-0">
                <div className="flex items-center gap-3 bg-white/60 backdrop-blur-sm px-4 py-2.5 rounded-full border border-gray-200/50 shadow-sm justify-center sm:justify-start">
                  ...
                  <span className="font-medium whitespace-nowrap">Licensed & Insured</span>
                </div>
                <div className="flex items-center gap-3 bg-white/60 backdrop-blur-sm px-4 py-2.5 rounded-full border border-gray-200/50 shadow-sm justify-center sm:justify-start">
                  <div className="w-2.5 h-2.5 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex-shrink-0"></div>
                  <span className="font-medium whitespace-nowrap">Quality Craftsmanship</span>
                </div>
                <div className="flex items-center gap-3 bg-white/60 backdrop-blur-sm px-4 py-2.5 rounded-full border border-gray-200/50 shadow-sm justify-center sm:justify-start">
                  <div className="w-2.5 h-2.5 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex-shrink-0"></div>
                  <span className="font-medium whitespace-nowrap">Free Estimates</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 justify-center items-center mb-16 sm:mb-20 px-4 sm:px-0">
              ...
              <button className="group bg-white/80 backdrop-blur-sm hover:bg-white text-gray-800 hover:text-gray-900 px-8 sm:px-10 py-4 text-base sm:text-lg font-semibold w-full sm:w-auto max-w-sm sm:max-w-none transform hover:scale-105 transition-all duration-300 rounded-xl border-2 border-gray-200 hover:border-gray-300 shadow-sm hover:shadow-lg">
                <span className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-sm sm:text-base">Call (619) 361-9906</span>
                </span>
              </button>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight">
              San Diego's Home Repair & Remodeling Experts
            </h2>
            <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We provide complete home improvement services throughout San Diego including drywall, fences, painting, plumbing, electrical, concrete work, driveways and more. Our local team delivers quality craftsmanship at competitive prices.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 lg:mb-20">
            ...
            <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From concrete work to complete renovations, we provide expert construction services throughout San Diego 
              that enhance your property's value and functionality.
            </p>
          </div>
              ...
              <div className="flex transition-transform duration-500 ease-in-out" id="services-carousel">
                ...
                <div className="w-full flex-shrink-0 flex justify-center">
                  <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200/50 hover:border-primary-200/50 max-w-lg w-full">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6 text-lg">
                      Professional concrete services including patios, driveways, stamped concrete, and retaining walls with precision and durability.
                    </p>
                ...
                <div className="w-full flex-shrink-0 flex justify-center">
                  <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200/50 hover:border-primary-200/50 max-w-lg w-full">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6 text-lg">
                      Expert installation of laminate flooring and professional drywall services for interior improvements and repairs.
                    </p>
                    <div className="flex items-center text-primary-600 font-medium group-hover:text-primary-700">
                      <span>Learn More</span>
                      <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                ...
                {/* Slide 3 - Fencing & Outdoor Structures */}
                <div className="w-full flex-shrink-0 flex justify-center">
                  <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200/50 hover:border-primary-200/50 max-w-lg w-full">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-primary-600 transition-colors">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6 text-lg">
                      Custom fence installation and outdoor structure construction to enhance your property's security and aesthetic appeal.
                    </p>
                    <div className="flex items-center text-primary-600 font-medium group-hover:text-primary-700">
                      <span>Learn More</span>
                      <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                ...
                <div className="w-full flex-shrink-0 flex justify-center">
                  <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200/50 hover:border-primary-200/50 max-w-lg w-full">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6 text-lg">
                      Licensed electrical and plumbing services for new installations, repairs, and upgrades to keep your home running smoothly.
                    </p>
                    <div className="flex items-center text-primary-600 font-medium group-hover:text-primary-700">
                      <span>Learn More</span>
                      <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                ...
                <div className="w-full flex-shrink-0 flex justify-center">
                  <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200/50 hover:border-primary-200/50 max-w-lg w-full">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6 text-lg">
                      Professional driveway construction and resurfacing using quality materials for long-lasting curb appeal and functionality.
                    </p>
                    <div className="flex items-center text-primary-600 font-medium group-hover:text-primary-700">
                      <span>Learn More</span>
                      <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                ...
                <div className="w-full flex-shrink-0 flex justify-center">
                  <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200/50 hover:border-primary-200/50 max-w-lg w-full">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6 text-lg">
                      Complete home renovation and remodeling projects from concept to completion, transforming your space into your dream home.
                    </p>
                    <div className="flex items-center text-primary-600 font-medium group-hover:text-primary-700">
                      <span>Learn More</span>
                      <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-14">
            ...
            <p className="text-lg lg:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Contact us today for a free consultation and estimate. We're here to bring your San Diego construction and remodeling vision to life.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:gap-10 lg:grid-cols-3 max-w-6xl mx-auto items-stretch">
            ...
            <div className="lg:col-span-2 flex flex-col justify-between bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-3xl shadow-xl p-8 sm:p-10 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Ready to start your San Diego construction project? Speak directly with our experienced local team to discuss your needs and get expert advice.
                </p>
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 justify-center sm:justify-start">
                  <a href="tel:+16193619906" className="group relative inline-flex items-center gap-3 px-8 py-5 rounded-2xl bg-gradient-to-r from-primary-600 to-blue-600 text-white font-semibold text-lg shadow-lg hover:shadow-2xl transition-all duration-300 hover:from-primary-700 hover:to-blue-700">
                    ...
                    <span className="flex flex-col items-start">
                      ...
                      <span className="text-2xl font-bold tracking-tight">(619) 361-9906</span>
                    </span>
                  ...
                  <div className="flex flex-col items-center sm:items-start">
                    ...
                    <ul className="text-sm text-gray-600 space-y-0.5">
                      ...
                      <li className="text-primary-600 font-medium">Sunday: By Appointment</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div className="relative mt-10 grid gap-6 sm:grid-cols-3">
                <div className="bg-white/70 backdrop-blur rounded-2xl p-5 border border-gray-200/60 shadow-sm">
                  ...
                  <p className="text-sm font-medium text-gray-800">San Diego & surrounding areas</p>
                </div>
                <div className="bg-white/70 backdrop-blur rounded-2xl p-5 border border-gray-200/60 shadow-sm">
                  <span className="block text-xs font-semibold tracking-wide text-primary-600 uppercase mb-2">Response</span>
                  <p className="text-sm font-medium text-gray-800">Free Consultation</p>
                </div>
                <div className="bg-white/70 backdrop-blur rounded-2xl p-5 border border-gray-200/60 shadow-sm">
                  <span className="block text-xs font-semibold tracking-wide text-primary-600 uppercase mb-2">Guarantee</span>
                  <p className="text-sm font-medium text-gray-800">Quality Workmanship</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8">
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-gray-200/60 shadow-lg p-8 flex flex-col">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">Request a Free Quote</h4>
                <p className="text-gray-600 text-sm mb-6">Get a personalized estimate for your San Diego construction project. Enter your phone number and we'll call you back to discuss your needs.</p>
                <form className="space-y-4" action="#" method="post" aria-disabled="true">
                  <div className="text-left">
                    ...
                    <input id="callbackPhone" type="tel" placeholder="(619) 361-9906" className="w-full rounded-xl border-gray-300 focus:border-primary-500 focus:ring-primary-500 px-4 py-3 text-gray-900 placeholder-gray-400 shadow-sm" disabled />
                  </div>
                  <button type="button" className="w-full inline-flex justify-center items-center gap-2 rounded-xl bg-gradient-to-r from-primary-600 to-blue-600 text-white font-semibold py-3.5 shadow-md transition-all duration-300 opacity-60 cursor-not-allowed">
                    <span>Request Free Quote (Demo)</span>
                  </button>
              ...
              <div className="bg-gradient-to-br from-primary-600 to-blue-600 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
                ...
                <h4 className="text-xl font-semibold mb-3 relative">Project Consultation</h4>
                <p className="text-white/90 text-sm mb-6 relative">Have a San Diego construction project in mind? Let's discuss your vision and provide expert local guidance to make it a reality.</p>
                <a href="tel:+16193619906" className="relative inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-white/15 backdrop-blur ring-1 ring-white/30 text-white font-semibold hover:bg-white/25 transition-all">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.72 19.72 0 0 1-8.59-3.07A19.5 19.5 0 0 1 3.15 9.77 19.72 19.72 0 0 1 .08 1.18 2 2 0 0 1 2.06-.9999999e-7h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L6.16 8.41a16 16 0 0 0 7.43 7.43l1.77-1.15a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92Z" /></svg>
                  <span className="text-lg font-bold">(619) 361-9906</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <footer className="py-8 text-center text-xs text-gray-500">
        © 2025 Alcaraz Construction. All rights reserved.
      </footer>
